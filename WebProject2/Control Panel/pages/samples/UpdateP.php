...
if (isset($_POST['Update'])) {
    ...
    $type = $_POST['type'];
    $price = $_POST['price'];
    $q = "UPDATE `product` SET `name` = '".$name."',discount='".$discount."',type='".$type."',price='".$price."',categoryId='".$categoryId."'  WHERE `id` = '".$id."'";
        ...
        <div class="main-panel">
          <div class="content-wrapper containerA">
            ...
            <form method="post">
            	...
            	<tr>
                  <td colspan="2"> <input class=" btn btn-gradient-primary font-weight-bold " id="add-task" type="submit" name="Update" value="Update"></td>
                </tr>               
                </table>
                </div>
              </div>
