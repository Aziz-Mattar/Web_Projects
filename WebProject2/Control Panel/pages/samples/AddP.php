...
if (isset($_POST['Add'])) {
    ...
    $price = $_POST['price'];
    $target = "../../../Public web site/images/".basename($_FILES['image']['name']);
    $image = $_FILES['image']['name'];
    move_uploaded_file($_FILES['image']['tmp_name'], $target);


    $q = "insert into product(name,type,categoryId,discount,price,image)values('".$name."','".$type."','".$categoryId."','".$discount."','".$price."','".$image."')";
    mysqli_query($conn,$q);
}
?>
<!DOCTYPE html>
        ...
        <div class="main-panel">
          ...
          <div class="content-wrapper containerA">
          	<form method="post" enctype="multipart/form-data">
            		...
            		<tr>
            			<td colspan="2"> <input class=" btn btn-gradient-primary font-weight-bold " id="add-task" type="submit" name="Add" value="Add"></td>
            		</tr>            		
	            	</table>
		            </div>
			        </div>
